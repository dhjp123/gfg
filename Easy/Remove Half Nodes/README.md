<h2><a href="https://practice.geeksforgeeks.org/problems/remove-half-nodes/1?page=6&category[]=Tree&sortBy=submissions">Remove Half Nodes</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given A binary Tree. Your task is to remove all the half nodes (which has only one child).</span></p>
