<h2><a href="https://practice.geeksforgeeks.org/problems/next-right-node/1?page=1&status[]=unsolved&category[]=Queue&sortBy=submissions">Next Right Node</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary tree and a key in the binary tree, find the node right to the given key. If there is no node on right side, then return a node with value -1.</span></p>
