<h2><a href="https://practice.geeksforgeeks.org/problems/sum-of-left-leaf-nodes/1?page=1&status[]=unsolved&category[]=Tree&sortBy=submissions">Sum of Left Leaf Nodes</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary Tree of size&nbsp;<strong>N. </strong>Find&nbsp;the sum of all the&nbsp;leaf nodes that are left&nbsp;child of their parent&nbsp;of the given binary tree.<br>
<br>
