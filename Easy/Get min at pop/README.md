<h2><a href="https://practice.geeksforgeeks.org/problems/get-min-at-pop/1?page=6&status[]=unsolved&sortBy=submissions">Get min at pop</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><em><span style="font-size:18px">Now, we'll try to solve a famous stack problem. </span></em><br>
