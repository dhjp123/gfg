<h2><a href="https://practice.geeksforgeeks.org/problems/palindrome-pairs/1?page=1&category[]=Trie&curated[]=1&sortBy=submissions">Palindrome Pairs</a></h2><h3>Difficulty Level : Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of strings arr[] of size N, find if there exists 2 strings arr[i] and arr[j] such that arr[i]+arr[j] is a palindrome i.e the concatenation of string arr[i] and arr[j] results into a palindrome.</span></p>
