<h2><a href="https://practice.geeksforgeeks.org/problems/number-is-sparse-or-not-1587115620/1?page=5&curated[]=1&sortBy=submissions">Number is sparse or not</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>.&nbsp;The task is to check whether it is<strong> sparse or not</strong>. A number is said to be a sparse number if <strong>no two or more consecutive bits are set&nbsp;</strong>in the binary representation</span>.<br>
<br>
